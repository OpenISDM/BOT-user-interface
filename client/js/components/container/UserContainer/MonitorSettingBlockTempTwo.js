									...
									<Row className="mx-4">
										<Col xl={9}>
											...
											<Row className="my-3" noGutters>
												<Col className="d-flex justify-content-around" xl={6}>
													<Col
														className="d-flex align-items-center justify-content-start px-0"
														xl={3}
													>
														<div>{locale.texts.ENABLE_START_TIME}:</div>
													</Col>
													<Col className="" xl={9}>
														<DateTimePicker
															id={item.id}
												...
												<Col className="d-flex justify-content-around" xl={6}>
													<Col
														...
														xl={3}
													>
														<div>{locale.texts.ENABLE_END_TIME}:</div>
													</Col>
													<Col className="" xl={9}>
														<DateTimePicker
															id={item.id}
															...
															name="end"
															start={
																parseInt(item.start_time.split(':')[0]) + 1
															}
															end="24"
														/>
													</Col>
