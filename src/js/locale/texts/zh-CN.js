...
const cn = {
    ...
    EXPORT_CSV: "汇出CSV",
    EXPORT_PDF: "汇出PDF",
    REQUEST_EMAIL_INSTRUCTION: "请输入您注册使用者帐号时所填写的电子信箱,系统将会寄出重设密码的连结到您的信箱.",
    ...
    THE_MAC_ADDRESS_IS_ALREADY_USED_OR_FORMAT_IS_NOT_CORRECT: "MAC位址已被使用或格式错误",
    ...
    /** User Setting */
    USER_SETTING: "帐户设定",
    DEVICES_MANAGEMENT: "仪器分配",
    USER_PROFILE: "个人资料",
    TRANSFERRED_LOCATION_MANAGEMENT: "新增/删除转移地点",
    ROLE_PERMISSION_MANAGEMENT: "身分权限管理",
    PATIENT_MANAGEMENT: "病人分配",
    SHIFT_CHANGE_RECORD: "交班纪录",
    ...
    PASSWORD_RESET_INSTRUCTION_SUCCESSFUL: "更改密码确认信已寄到您的信箱，请依照邮件指示更改您的密码",
