...
const ms =  {
    ...
    SETTINGS: "tetapan",
    GENERAL_SETTINGS: "Tetapan tersuai",
    ASSET_USAGE: "Catat data penggunaan aset",
    DEVICE_TRANSFER_RECORD: "Hasilkan rekod pemindahan peranti",
    NOTES_ON_PATIENTS: "Hasilkan dan lihat nota pada pesakit",
    GENERATE_AND_VIEW_SHIFT_CHANGE_RECORD: "Hasilkan dan lihat rekod perubahan shift",
    DEVICE_SERVICE_REQUEST: "Minta perkhidmatan pembaikan peranti",
    OBJECT_TRACKING: "Minta jejak objek",
    ...
    REQUEST_EMAIL_INSTRUCTION: "Masukkan alamat e-mel yang anda gunakan semasa anda bergabung dan kami akan mengirimkan arahan untuk menetapkan semula kata laluan anda.",
    ...
    LOCATION: "makluman lokasi",
    GEOFENCE: "amaran geofence",
    PANIC: "darurat",
    ...
    THE_MAC_ADDRESS_IS_ALREADY_USED_OR_FORMAT_IS_NOT_CORRECT: "Alamat Mac sudah digunakan atau formatnya salah",
    ...
    PLEASE_ENTER_OR_SCAN_ASSET_CONTROL_NUMBER: "sila masukkan atau imbas nombor kawalan aset",
    ...
    DEVICES_MANAGEMENT: "Penugasan peranti",
    PATIENT_MANAGEMENT: "Tugasan pesakit",
    USER_PROFILE: "Profil Pengguna",
    TRANSFERRED_LOCATION_MANAGEMENT: "Tambah / Padamkan Lokasi Pindahan",
    ROLE_PERMISSION_MANAGEMENT: "kebenaran peranan",
    SHIFT_CHANGE_RECORD: "peralihan rekod perubahan",
    ...
    USER_MANAGER: "Tambah / Padam Akaun Pengguna",
    ADMIN: "Pentadbir",
    CONFIRM: "Sahkan",
    ...
    NOW_YOU_CAN_DO_THE_FOllOWING_ACTION: "Sekarang anda boleh melakukan tindakan berikut",
    USERNAME_OR_PASSWORD_IS_INCORRECT: "Nama pengguna atau kata laluan tidak betul",
    ...
    PASSWORD_RESET_INSTRUCTION_SUCCESSFUL: "arahan penetapan semula kata laluan telah dihantar ke e-mel anda. Ikuti arahan untuk menetapkan semula kata laluan.",
